            ...
            <div style="flex: 1; display: flex; align-items: center; justify-content: center">
                <el-form :model="user" style="width: 80%">
                    ...
                    <el-form-item prop="nickname">
                        <el-input size="medium" show-password placeholder="请输入昵称" v-model="user.nickname" :prefix-icon="User"></el-input>
                    </el-form-item>
                    <el-form-item prop="nickname">
                        <el-input size="medium" show-password placeholder="请输入邮箱" v-model="    user.email" :prefix-icon="Message"></el-input>
                    </el-form-item>
                    <el-form-item prop="nickname">
                        <el-input size="medium" show-password placeholder="请输入手机号" v-model="user.phone" :prefix-icon="Iphone"></el-input>
                    </el-form-item>
