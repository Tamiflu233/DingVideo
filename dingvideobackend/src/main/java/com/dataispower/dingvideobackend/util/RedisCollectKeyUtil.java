...
public class RedisCollectKeyUtil {
    public static final String USER_COLLECTED_KEY = "COLLECTED_USER_KEY::";
    public static final String POST_COLLECTED_KEY = "COLLECTED_POST_KEY::";
    public static final String POST_COLLECTED_NUM_KEY = "COLLECTED_POST_NUM";
